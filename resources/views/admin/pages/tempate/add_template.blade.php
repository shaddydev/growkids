...
@section('title', 'Admin|Add-Template')
@section('content')
                  ...
                  {{csrf_field()}}
                        ...
                        <select name = "product_category" class = "form-control">
                          <option value = "">Choose Product Or Category</option>
                            @forelse($procat as $row)
                              <option value = "{{$row->id}}" {{old('product_category') == $row->id ? 'selected' : ''}}>{{ parentcatname($row->parent_id) != '' ? parentcatname($row->parent_id)->name.'->' : ''}} {{ $row->name}} {{$row->type == 1 ? "(Product)" : "(Category)"}} </option>
                            @empty
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10 col-sm-9">
                        <input class="form-control" id="version" name="version"  type="text" value = "{{ old('version')}}"/>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="heading" name="heading" minlength="3" type="text" value = "{{ old('heading')}}"/>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="subheading" name="subheading" minlength="3" type="text" value = "{{ old('subheading')}}"/>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="title_area" name="title_area" minlength="3" type="text" value = "{{ old('title_area')}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <textarea class="form-control ckeditor" name="description_area" rows="6">{{ old('description_area')}}</textarea>
                     ...
                     <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="seo_title" name="seo_title" minlength="3" type="text" value = "{{ old('seo_title')}}"/>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <textarea class="form-control" id="seo_meta_keyword" name="seo_meta_keyword" minlength="3" />{{ old('title_area')}}</textarea>
